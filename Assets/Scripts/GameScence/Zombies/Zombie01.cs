...
public class Zombie01 : MonoBehaviour
{
    ...
    void Update()
    {
        if (isAlive)
        {
            ...
            if (playerDis > range && dist)   // Condition for idle position   //if the distance from zombie and player is big than zombie goes into idle animation
            {
            ...
            else if (playerDis < range && dist) // When the player in range       //if the distance from zombie and player small like close than zombie goes into walk animation
            {
